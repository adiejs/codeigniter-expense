            ...
            <div class="modal-body">
                <?= form_open('expenses/create') ?>
                    <div class="form-group">
                      ...
                      <select id="nama-produk" name="nama_akun" class="js-example-basic-single select2" onchange="autocompleted()">
                        <?php foreach ($data as $d): ?>
                          <option value="<?= $d->nama_akun ?>"  
                          data-kode="<?= $d->kode_akun ?>">
                          <?= $d->nama_akun ?>
                        </option>
                        <?php endforeach; ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <input readonly id="kode-produk" name="kode_akun" type="text" class="form-control" /> 
                    </div>

                      <input hidden id="harga-modal" name="harga_modal" type="text" class="form-control" />   

                      <input hidden id="harga-jual" name="harga_jual" type="text" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <input hidden id="total" name="total" type="text" class="form-control" />


                      <input hidden id="laba" name="laba" type="text" class="form-control" />
